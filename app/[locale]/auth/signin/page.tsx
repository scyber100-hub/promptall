      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-900">{t('signin_title')}</h1>
            <p className="text-sm text-gray-500 mt-1">{t('signin_subtitle')}</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            {t('no_account')}{' '}
            <Link href={`/${locale}/auth/signup`} className="text-indigo-600 hover:underline font-medium">
              {t('signup_link')}
            </Link>
          </p>
        </div>
